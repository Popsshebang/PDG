...
function scientificToDecimal($x, precision) {
    ...
    var $tmptmptmp = $x; // for debuging printing

	var $normNumber = ""; // for debuging printing
	var $num = "";
	var $numTmp = "";
	var $numSign = "";
...
/*		
		return "original number is  " + $tmptmptmp +
		"\n e is at " + ePosition + "  " + $x + 
		"\n intPart = " + intPart + 
		"\n decPart = " + decPart + 
		"\n decPart length = " + decPart.length +
		"\n power of = "+expPower + 
		"\n $numSign = "+ $numSign +
		"\n typeof buildNum " + typeof $buildNum +
		"\n $buildNum number is " + Number($buildNum).toFixed(precision);
*/		
		...
		//expPower++;
		//expPower = expPower - $buildNum.length;
...
/*
		...
		"\n decPart = " + decPart + 
		"\n decPart length = " + decPart.length +
		"\n $rightStrDecPart = " + $rightStrDecPart +
		"\n $leftStrDecPart = " + $leftStrDecPart +
		"\n expPower = "+expPower + 
		"\n expPowerTmp = "+expPowerTmp + 
		"\n $numSign = "+ $numSign +
		"\n typeof buildNum = " + typeof $buildNum +
		"\n $buildNum number is " + Number($buildNum).toFixed(precision);
*/
